...
class User(Base, UUIDPrimaryKey):
    ...
    email: Mapped[str] = mapped_column(String(100), comment="Почта")
    username: Mapped[str] = mapped_column(String(30), comment="Имя пользователя")
    ...
    image: Mapped[str] = mapped_column(comment="Путь к файлу изображения пользователя")
